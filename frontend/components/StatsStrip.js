...
function MiniGauge({ value = 50, label }) {
  ...
  return (
    <div className="snap-start shrink-0 min-w-[85%] sm:min-w-[300px] lg:min-w-0 lg:flex-1 bg-bg-card border border-border rounded-xl px-4 py-3 flex items-center gap-3">
...
export default function StatsStrip({ marketOverview, sentiment }) {
  ...
  return (
    <div className="flex gap-2 px-3 py-2 shrink-0 overflow-x-auto no-scrollbar snap-x snap-mandatory lg:snap-none">
      {/* BTC/ETH Price Card */}
      <div className="snap-start shrink-0 min-w-[85%] sm:min-w-[300px] lg:min-w-0 lg:flex-1 bg-bg-card border border-border rounded-xl px-4 py-3 flex items-center justify-between gap-4">
      ...
      {/* Market Health Card */}
      <div className="snap-start shrink-0 min-w-[85%] sm:min-w-[300px] lg:min-w-0 lg:flex-1 bg-bg-card border border-border rounded-xl px-4 py-3 flex items-center gap-4">
